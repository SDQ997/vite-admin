<template>
    <div class="index">
        <el-container class="elContainer">
            <el-aside class="elAside" :width="slideIsRetract ? 50+'px' : 200+'px'">
                <div class="indexAside"></div>
            </el-aside>
            <el-container>
...
const changeSlide = ()=>{
    proxy.$store.commit("changeState",{key:"slideIsRetract",value:!slideIsRetract.value})
}
</script>
    ...
    .elContainer{
        ...
        .indexHeader{
            ...
            .leftMenu{
                ...
                .retractButton:hover{
                    background-color: rgba(0,21,41,.05);
                }
            }
            .rightMenu{
                display: flex;
